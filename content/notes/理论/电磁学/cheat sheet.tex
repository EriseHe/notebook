...
If $\sigma_f=0$:
\[
\cboxed{\epsilon_1 E_1^\perp=\epsilon_2 E_2^\perp}
\qquad
\cboxed{E_1^\parallel=E_2^\parallel}
\]
Hence field-line bending:
\[
\cboxed{\frac{\tan\theta_1}{\tan\theta_2}=\frac{\epsilon_1}{\epsilon_2}}
\]
...
\]
\[
\cboxed{C_{\rm pp}=\frac{\epsilon A}{d}}
\qquad
\cboxed{u=\frac12 \mathbf D\cdot \mathbf E=\frac12\epsilon E^2=\frac{D^2}{2\epsilon}}
\]
\[
\cboxed{W_{\rm all\ charges}=\frac{\epsilon_0}{2}\int E^2\,d\tau}
\]
...
\]
For slab width $w$ and plate separation $d$:
\[
\cboxed{|F|=\frac{\epsilon_0\chi_e w}{2d}V^2}
\]
...
\]
For moving line charge density $\lambda$:
\[
\cboxed{I=\lambda v}
\]
\[
...
\]
Parallel wires distance $s$:
\[
\cboxed{\frac{F}{L}=\frac{\mu_0 I_1I_2}{2\pi s}}
\]
...
\]
\[
\cboxed{B_{\rm axis\ of\ loop}(z)=\frac{\mu_0 I R^2}{2(R^2+z^2)^{3/2}}}
\]
Finite straight segment:
\[
\cboxed{B=\frac{\mu_0 I}{4\pi s}\,(\sin\theta_1+\sin\theta_2)}
\]
Circular arc of angle $\phi$ (radians):
\[
\cboxed{B_{\rm arc}=\frac{\mu_0 I\phi}{4\pi R}}
\]
...
\[
\cboxed{|\mathbf K_b|=M\ \text{for side surface of uniformly magnetized cylinder}}
\]
\key{Uniformly magnetized sphere:}
\[
\cboxed{\mathbf m_{\rm sphere}=\frac{4\pi R^3}{3}\mathbf M}
\]
\[
\cboxed{\mathbf H_{\rm in}=-\frac{\mathbf M}{3}}
\qquad
\cboxed{\mathbf B_{\rm in}=\frac{2}{3}\mu_0\mathbf M}
\]
...
If no free surface current at interface of linear media:
\[
\cboxed{B_1^\perp=B_2^\perp}
\qquad
\cboxed{\frac{B_1^\parallel}{\mu_1}=\frac{B_2^\parallel}{\mu_2}}
\]
\[
\cboxed{\frac{\tan\theta_1}{\tan\theta_2}=\frac{\mu_1}{\mu_2}}
\]

...
lecture: "5"
---
# 1 Pushforward, Pullback, and Local Isometry
...
$$
### 1.4.4 Chain-rule detail (as on the board)
...
# 2 Surface Area Element from the First Fundamental Form
...
### 2.1.1 Expressing $dA$ with the first fundamental form
...
### 2.1.2 Coordinate-invariance check
...
# 4 Curvature of surfaces: deviation from the tangent plane
...
### 4.2.1 Shape operator, principal/mean/Gauss curvature

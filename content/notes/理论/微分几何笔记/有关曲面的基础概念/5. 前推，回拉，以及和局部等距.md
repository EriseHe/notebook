...
## 0.4 Example: helicoid $\longleftrightarrow$ catenoid
...
### 1.1.2 Coordinate-invariance check
...
### 2.1.2 Sphere in cylindrical coordinates
Use
...
## 3.2 Taylor expansion and the second fundamental form

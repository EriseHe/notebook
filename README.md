...
- The 300px menu uses compact 26px single-line rows, 18px wrapped line height, 14px nesting steps, and no extra margin between entries. Numbered notes have 12px left padding and an 8px number-to-title gap, leaving some breathing room without a large reserved arrow gutter.
